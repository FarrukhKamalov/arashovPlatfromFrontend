                        ...
                        <div className="w-full my-3 gap-6 py-3 rounded-2xl px-5">
                            ...
                            ?
                                <><div className="w-full">
                                    ...
                                    <input onInput={e => setInputs({...inputs, videoTitle: e.target.value})} value={inputs?.videoTitle} {...register("videoTitle")} required className="outline-0 border-0 text-gray-200 bg-gray-700 rounded-md px-5 py-2 w-full focus:ring-2 ring-gray-600" type="text" placeholder="Post title..." name="videoTitle" id="" />
                                </div>
                                
                                <div className="w-full my-3 gap-6 py-3 rounded-2xl">
                                    <h1 className="text-xl">Post image URL</h1>
                                    <input onInput={e => setInputs({...inputs, videoLink: e.target.value})} value={inputs?.videoLink}  {...register("videoLink")} required className="outline-0 border-0 bg-gray-700 text-gray-200 rounded-md px-5 py-2 w-full focus:ring-2 ring-gray-600" type="text" placeholder="Post image URL..." name="videoLink" id="" />
                                </div></>
                                :
                                <div className="w-full my-3 gap-6 py-3 rounded-2xl">
                                    <div className="my-5">
